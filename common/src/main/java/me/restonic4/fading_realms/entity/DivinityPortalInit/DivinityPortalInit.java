...
public class DivinityPortalInit extends Animal {
    public final AnimationState idleAnimationState = new AnimationState();

    public DivinityPortalInit(EntityType<? extends Animal> entityType, Level level) {
    ...
    public void tick() {
        if (level().isClientSide()) {
            ...
            CommandManager.divinityPortalInit = this;
        }
